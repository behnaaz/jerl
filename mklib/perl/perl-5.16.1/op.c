...
/* JERL : this wasn't being set for some reason */
#ifndef IN_LOCALE_COMPILETIME
#define IN_LOCALE_COMPILETIME (1==0)
#endif
...
Perl_newPMOP(pTHX_ I32 type, I32 flags)
{
    ...
    //JERL if (IN_LOCALE_COMPILETIME) {
    //JERL	set_regex_charset(&(pmop->op_pmflags), REGEX_LOCALE_CHARSET);
    //JERL}
