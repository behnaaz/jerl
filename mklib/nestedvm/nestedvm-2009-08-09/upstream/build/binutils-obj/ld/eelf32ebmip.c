...
static void gldelf32ebmip_before_parse
  PARAMS ((void));
static void gldelf32ebmip_vercheck
  PARAMS ((lang_input_statement_type *));
static void gldelf32ebmip_stat_needed
  PARAMS ((lang_input_statement_type *));
static bfd_boolean gldelf32ebmip_try_needed
  PARAMS ((const char *, int));
static bfd_boolean gldelf32ebmip_search_needed
  PARAMS ((const char *, const char *, int));
static void gldelf32ebmip_check_needed
  PARAMS ((lang_input_statement_type *));
static void gldelf32ebmip_after_open
  PARAMS ((void));
static void gldelf32ebmip_find_exp_assignment
  PARAMS ((etree_type *));
static void gldelf32ebmip_find_statement_assignment
  PARAMS ((lang_statement_union_type *));
static void gldelf32ebmip_before_allocation
  PARAMS ((void));
static bfd_boolean gldelf32ebmip_open_dynamic_archive
  PARAMS ((const char *, search_dirs_type *, lang_input_statement_type *));
static lang_output_section_statement_type *output_rel_find
  PARAMS ((asection *));
static asection *output_prev_sec_find
  PARAMS ((lang_output_section_statement_type *));
static bfd_boolean gldelf32ebmip_place_orphan
  PARAMS ((lang_input_statement_type *, asection *));
static void gldelf32ebmip_finish
  PARAMS ((void));
static char *gldelf32ebmip_get_script
  PARAMS ((int *isfile));
...
static bfd_boolean
gldelf32ebmip_try_needed (name, force)
     const char *name;
     int force;
{
  bfd *abfd;
...
static bfd_boolean
gldelf32ebmip_search_needed (path, name, force)
     const char *path;
     const char *name;
     int force;
{
  ...
  if (name[0] == '/')
    return gldelf32ebmip_try_needed (name, force);
  ...
  while (1)
      ...
      else
	{
      ...
      if (gldelf32ebmip_try_needed (filename, force))
	return TRUE;
...
static void gldelf32ebmip_add_options
  PARAMS ((int, char **, int, struct option **, int, struct option **));

static void
gldelf32ebmip_add_options (ns, shortopts, nl, longopts, nrl, really_longopts)
     int ns;
     char **shortopts;
     int nl;
...
static bfd_boolean gldelf32ebmip_handle_option
  PARAMS ((int));

static bfd_boolean
gldelf32ebmip_handle_option (optc)
     int optc;
{
  switch (optc)
    {
...
static void gldelf32ebmip_list_options PARAMS ((FILE * file));

static void
gldelf32ebmip_list_options (file)
     FILE * file;
{
